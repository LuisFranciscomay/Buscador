...
<div class="container">
    ...
    <div class="clontainer">
        <form method="post" action="{{('/providers')}}" class="form-horizontal" id="form-products" enctype="multipart/form-data">
        @csrf
        ...
        <!-- segmento nombre -->
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="location" class="control-label">Ciudad</label>
